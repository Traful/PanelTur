...
class FormEve extends Component {
    ...
    saveData(event) {
        ...
        */
        ...
        fetch(`${process.env.REACT_APP_API_HOST}/evento/${this.state.registro.id}`, {
            method: "POST",
            headers: {
                "Authorization": token,
            },
                            ...
                            <div className="col-sm-12 col-md-3">
                                <div>
                                    ...
                                    <img
                                        ...
                                        src={`${process.env.REACT_APP_API_HOST}/${process.env.REACT_APP_API_DIRECTORY_EVENTOS_FOTOS}/${this.state.registro.foto_uno}`}
                                        alt="Foto"
                                ...
                                <div>
                                    ...
                                    <img
                                        ...
                                        style={{width: "250px", height: "200px", objectFit: "cover"}}
                                        src={`${process.env.REACT_APP_API_HOST}/${process.env.REACT_APP_API_DIRECTORY_EVENTOS_FOTOS}/${this.state.registro.foto_dos}`}
                                        alt="Foto"
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-12 col-md-6">
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="titulo" id="titulo" className="form-control" value={this.state.registro.titulo} onChange={this.handleInputChange} maxLength="100" />
                                        </div>
                                    </div>
                                    <div className="col-sm-12 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="lugar">Lugar</label>
                                            <input type="text" name="lugar" id="lugar" className="form-control" value={this.state.registro.lugar} onChange={this.handleInputChange} maxLength="100" />
                                        </div>
                                    </div>
                                    <div className="col-sm-12 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="direccion">Dirección</label>
                                            <input type="text" name="direccion" id="direccion" className="form-control" value={this.state.registro.direccion} onChange={this.handleInputChange} maxLength="100" />
                                        </div>
                                    </div>
                                    <div className="col-sm-12 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="invita">Invita</label>
                                            <input type="text" name="invita" id="invita" className="form-control" value={this.state.registro.invita} onChange={this.handleInputChange} maxLength="50" placeholder="Ej: Ministerio de Turísmo y Parques" />
                                        </div>
                                    </div>
                                    <div className="col-sm-12 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="organiza">Organiza</label>
                                            <input type="text" name="organiza" id="organiza" className="form-control" value={this.state.registro.organiza} onChange={this.handleInputChange} maxLength="50" placeholder="Ej: Gobierno de San Luis" />
                                        </div>
                                    </div>
                                    <div className="col-sm-12 col-md-12">
                                        <div className="form-group">
                                            <label htmlFor="descripcion">Descripción</label>
                                            <textarea rows="5" name="descripcion" id="descripcion" className="form-control" value={this.state.registro.descripcion} onChange={this.handleInputChange} maxLength="50" />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label htmlFor="dfecha">Desde Fecha</label>
                                            <input type="date" name="dfecha" id="dfecha" className="form-control" value={this.state.registro.dfecha} onChange={this.handleInputChange} />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label htmlFor="hfecha">Hasta Fecha</label>
                                            <input type="date" name="hfecha" id="hfecha" className="form-control" value={this.state.registro.hfecha} onChange={this.handleInputChange} />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label htmlFor="dhora">Desde Hora</label>
                                            <input type="text" name="dhora" id="dhora" className="form-control" value={this.state.registro.dhora} onChange={this.handleInputChange} />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label htmlFor="hhora">Hasta Hora</label>
                                            <input type="text" name="hhora" id="hhora" className="form-control" value={this.state.registro.hhora} onChange={this.handleInputChange} />
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="form-group">
                                            <label htmlFor="costo">Costo</label>
                                            <input type="text" name="costo" id="costo" className="form-control" value={this.state.registro.costo} onChange={this.handleInputChange} />
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col">
                                        <div className="d-flex justify-content-between">
                                            <button type="button" className="btn btn-danger" onClick={() => this.askDelete(this.state.registro.titulo)}><i className="fas fa-trash"></i></button>
